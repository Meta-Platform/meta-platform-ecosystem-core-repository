...
*/
const DescreverAmbiente = (envDoContainer = [], envDaImagem = []) => {
...
const DescreverPortas = (config = {}, hostConfig = {}) => {
...
const DescreverMontagens = (mounts = [], hostConfig = {}) => {
    ...
    return (hostConfig.Binds || []).map((bind) => {
...
const DescreverRecursos = (hostConfig = {}) => SemVazios({
    ...
    ulimits: (hostConfig.Ulimits || []).map((u) => ({ name: u.Name, soft: u.Soft, hard: u.Hard }))
})

const DescreverRede = (config = {}, hostConfig = {}, networkSettings = {}) => {
...
*/
const DescribeContainerSpec = (inspect = {}, { imageEnv } = {}) => {
    ...
    return SemVazios({
        ...
        devices: (hostConfig.Devices || []).map((d) => SemVazios({
        ...
        security: SemVazios({
            ...
            securityOpt: (hostConfig.SecurityOpt || []).filter((o) => o !== "no-new-privileges:true"),
