...
const expressWs     = require("express-ws") as any
const cookieParser = require('cookie-parser') as any

const fs = require("fs") as typeof import("fs")

const CreateAPIEndpointsService    = require("../Helpers/CreateAPIEndpointsService") as (options: any) => any
const CreateStaticEndpointsService = require("../Helpers/CreateStaticEndpointsService") as (options: any) => any
...
const HTTPServerService = (params: any) => {
    ...
    */
    ...
    const _HandleServerError = (err: any) => {
    ...
    const AddStaticEndpoint = ({path, staticDir, needsAuth}: { path: string, staticDir: string, needsAuth?: boolean }) => {
    ...
    const AddServiceEndpoint = ({path, apiTemplate, service, needsAuth}: { path: string, apiTemplate: any, service: any, needsAuth?: boolean }) => {
