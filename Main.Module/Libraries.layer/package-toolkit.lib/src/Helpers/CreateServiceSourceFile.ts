...
const CreateServiceSourceFile = async ({ servicesDirPath, namespace, params, boundParams }: { servicesDirPath: string, namespace: string, params: string[], boundParams: string[] }) => {
...
const ${namespace}Service = (params: any) => {
...
module.exports = CreateServiceSourceFile