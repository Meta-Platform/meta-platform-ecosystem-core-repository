...
//
// Era byte-idêntico (a menos de comentários) no launcher, no painel de
// instâncias, no container-manager, no package-developer, no my-desktop e no
// ecosystem-control-panel — atravessa área, por isso mora no kit comum.
